...
f1=getFeatureVectorReplaceNexP50(nexFilePaths{1});
...
cellFeatureTable=cell2table(f1,'VariableNames',{'ptID','szID','nexP50','butter300TPwidth','butter300T15','butter300T30','butter300T75','butter300TFirstPwidth','butter300P25','butter300T50','butter300P75'});
...
for fileNum=2:length(nexFilePaths)
	...
	f=getFeatureVectorReplaceNexP50(nexFilePaths{fileNum});
...
if(replot)
	groupName='AllPatientsAndSeizures';

function humanConvertNS5toMat(checkBeforeConverting, subject, ns5Filename, ns5VisChannels, ns5SeqChannels, fullPath, processedDataDir, saveDecimated)
...
numSimChLoad = 5; % How many channels to process at a time, 5 is optimal to not run out of memory

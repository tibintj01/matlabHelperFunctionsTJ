function [surrogateMeanDiffs,originalMeanDiff]=getBootstrapTwoGpMeanDiff(gp1Vals,gp2Vals,Nbootstrap)
...
showPlots=1;
    ...
    for i=1:n1vals
        gp2MinusGp1(i)=diff([gp1Vals(i),gp2Vals(i)]);
    ...
    for i=1:Nbootstrap
        ...
        for j=1:n1vals
            gp2MinusGp1(j)=diff([gp1SurrogateVals(j),gp2SurrogateVals(j)]);

function [estAccPerTimeStep] = getLocalAcc(originalData,cycleStartTimes,gaussTimeAxis,localGaussSpikeRatePerTime)
    ...
    posXPerTimeStep=originalData.linear_track{1}.nonlinearFrames(:,2);
    posYPerTimeStep=originalData.linear_track{1}.nonlinearFrames(:,3);

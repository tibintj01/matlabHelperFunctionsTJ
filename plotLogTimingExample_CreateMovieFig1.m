...
movieFrameDir='logTransformMovieFrames';

touchDir(movieFrameDir);
...
for s=1:numScalings
        ...
        if(s<10)
         ...
         if(s<10)
         %saveas(gcf,sprintf('logTimingExampleFigScaling0%d.tif',s))
         print(fullfile(movieFrameDir,sprintf('logTimingExampleFigScaling0%d',s)),'-depsc')
        else
            %saveas(gcf,sprintf('logTimingExampleFigScaling%d.tif',s))
            print(fullfile(movieFrameDir,sprintf('logTimingExampleFigScaling%d',s)),'-depsc')
         end

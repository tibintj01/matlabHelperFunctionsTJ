function [cellProp] = processCellProperties(subject,descriptiveFilename, ch, indWithinCh, nexLoadDir, saveDir)
...
sessIdx=getSessionIdxMG(subject)
...
[filtWaveforms]=getFiltWaveformsOfCell(ns5DirName,descriptiveFilename,ch,spikeTimes,rawSamplesBefore,rawSamplesAfter);

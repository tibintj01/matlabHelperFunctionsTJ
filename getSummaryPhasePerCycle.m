function [summaryPhasePerCycle] = getSummaryPhasePerCycle(currFieldTimeCenters,currFieldAllTimes,currFieldSpikePhases,gaussKernelWidth)
%gets most common phase at each time bin center

function [surrogateMeanDiffs,originalMeanDiff]=getBootstrapTwoGpCircMeanDiff(gp1Vals,gp2Vals,Nbootstrap)
...
showPlots=1;
    ...
    originalMeanDiff=circMeanDegNoMod360(gp2MinusGp1);
    ...
    for i=1:Nbootstrap
        ...
        currSurrogateMeanDiff=circMeanDegNoMod360(gp2MinusGp1);

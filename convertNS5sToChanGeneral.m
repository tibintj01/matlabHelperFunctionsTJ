function [] = convertNS5sToChanGeneral(ses) 
...
%dataDir='/nfs/turbo/lsa-ojahmed/FOR_TIBIN_otherPts/MG29/NS5_NEV';
dataDir='/nfs/turbo/lsa-ojahmed/FOR_TIBIN_otherPts';
...
%humanConvertEDFtoMat(checkBeforeConverting, subject, edfFilename, edfSeqChannels, originalDataDir, processedDataDir)
        ...
        for currNS5Ind = 1:dataInfo(currSes).numNS5Files % LOOP AROUND ALL NS5 FILES
            ...
            humanConvertNS5toMat_TJ(checkBeforeConverting, dataInfo(currSes).subject, currNS5Filename, ...
